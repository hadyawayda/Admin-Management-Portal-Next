    ...
    <div className="flex justify-between h-screen w-full tasks">
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="py-3 px-6 sm:px-12 spacing">
        ...
        <div className="flex flex-col justify-between h-30">
          <div className="h-12 toggle text-center mx-6 rounded-md py-3">
            Toggle Dark Mode
          </div>
          <button
            onClick={handleSidebar}
            className="h-20 text text-center py-4"
          >
            Hide Sidebar
          </button>
        </div>
      ...
      <div className="flex w-full flex-col justify-between">
        <div className="flex justify-between h-24 w-full p-6 border-b border-gray-600 tasks">
          ...
          <button
            type="button"
            className="boards rounded-full px-6"
